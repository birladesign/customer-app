  ...
  return (
    <div className="home">
      ...
      <main className="home__content">
        {/* Above the promos on purpose: something wrong with an order the
            customer has already paid for outranks anything we want to sell
            them next. */}
        {prompts.length > 0 && (
